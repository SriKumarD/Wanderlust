...
class Home extends Component {
    ...
    getPackages = () => {
        const continent=this.state.continent.charAt(0).toUpperCase() + this.state.continent.substring(1).toLowerCase();
                    ...
                    Not all those who wander are lost.</h2>
                            <div className="form-inline d-flex">
                                <input
                                    ...
                                    placeholder="Where?"
                                />&nbsp;
                    <button className="btn btn-info mx-auto" style={{padding:"16.5px 40px"}} disabled={(this.state.continent==="")?true:false} onClick={this.getPackages}>Search</button>
